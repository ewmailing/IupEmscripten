...
IUP_EXPORTI  * call \ref iupClassObjectComputeNaturalSize for containers if they have children or
...
IUP_EXPORTI  * Call \ref iupClassObjectSetChildrenCurrentSize for containers if they have children.
 * Must be called for each children in the container. \n
 * First call is in iupLayoutCompute.
 * \ingroup iclassbase */
...
IUP_EXPORTI  * Call \ref iupClassObjectSetChildrenPosition for containers if they have children.
 * Must be called for each children in the container. \n
 * First call is in iupLayoutCompute.
 * \ingroup iclassbase */
...
IUP_EXPORTI    Called only from iupdrvSetFontAttrib. */
 ...
 * \par
IUP_EXPORTI  * Used by the controls for iupClassRegisterAttribute. 
 * \par
 * See \ref iup_classbase.h
 * \ingroup iclassbase
 * @{
